...
/**
 * JsonResourceCollection class to handle API resource transformation and response building for collections
 */
export class JsonResourceCollection<R extends ResourceData[] | Collectible = ResourceData[], T extends ResourceData = any> {
  [key: string]: any;
